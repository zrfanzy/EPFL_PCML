...
-- vgg:add(nn.Linear(36865, 36864))
-- vgg:add(nn.View(1024,6,6))
print(2)
vgg:add(nn.View(36864,1,1))
vgg:add(nn.SpatialConvolution(36864, 512,1,1, 1,1 ))
-- classifier:add(nn.Dropout(0.5))
-- vgg:add(MaxPooling(2,2,2,2):ceil())
vgg:add(nn.ReLU(true))
print(3)
vgg:add(nn.SpatialConvolution(512, 4,1,1,1,1 ))
vgg:add(nn.ReLU(true))
